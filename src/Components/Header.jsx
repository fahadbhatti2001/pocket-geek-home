...
export const Header = (props) => {
  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg shadow-md bg-white relative flex items-center w-full justify-between px-6 py-4 border-4 border-t-0 border-primary-3">
